...
while True:
    ...
    if 1:
        outputString += "ACCZ %5.2f ACCY %5.2f ACCx %5.2f"% (ACCz, ACCy,ACCx)
    if abs(prevACCy-ACCy)<=30:
        outputString += "None"
    elif prevACCy - ACCy <= 0:
        outputString+= "Forward"
    else:
        outputString += "Backward"
    if abs(prevACCz-ACCz)<=30:
        outputString += " None"
    elif prevACCz - ACCz <= 0:
        outputString+= " Up"
    else:
        outputString += " Down"
